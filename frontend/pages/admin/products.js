              ...
              <div key={p.id} style={{ border: "1px solid #333", padding: 12, borderRadius: 10 }}>
                <div style={{ display: "flex", justifyContent: "space-between", gap: 12 }}>
                  <div style={{ display: "flex", gap: 12 }}>
                    <div style={{ width: 90 }}>
                      {img ? <img src={img} alt={p.name} style={{ width: 90, height: 90, objectFit: "cover", borderRadius: 10, border: "1px solid #333" }} /> : <div style={{ width: 90, height: 90, borderRadius: 10, border: "1px solid #333" }} />}
                    </div>
